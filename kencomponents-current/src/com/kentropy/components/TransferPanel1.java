...
public class TransferPanel1 extends XPanel implements ActionListener,
		ComponentListener {
	...
	public class Task implements Runnable{
		...
		public void run() {
			...
			String curAction="";
			try {
				si.setStatus("Code Sync", "NotStarted");
				si.setStatus("Upload", "NotStarted");
				si.setStatus("Download", "NotStarted");
				...
				tfp.si.setStatus("Code Sync","Processing");
				syncCode();
				//
				tfp.si.setStatus("Code Sync","Complete");
				tfp.ta.append("\nStarting Data Synchronization...");
				tfp.si.setStatus("Upload","Processing");
				curAction="Upload";
				tfp.ta.append("\n-------------------");
				tfp.ta.append("\nStarting Upload...");
				upload();
				tfp.si.setStatus("Upload","Complete");
				tfp.ta.append("\nUpload Completed");
				tfp.si.setStatus("Download","Processing");
				...
				tfp.si.setStatus("Download","Complete");
				...
				tfp.si.setStatus(curAction,"Failed");
		...
		public TransferPanel1 tfp=null;
	...
	public StatusIndicator si= new StatusIndicator();
	...
	public void display(String htext, String msg) {
		...
		this.setBounds(10, 50, this.getParent().getWidth()-20, this.getParent().getHeight()-20);
		setName("error");
		...
		ta.setBounds(3, 3, this.getWidth()-6, this.getHeight()/2-6);
		ta.setEditable(false);
		ta.setText(msg);
		
		
		si.setBounds(3, this.getHeight()/2, this.getWidth()-6, this.getHeight()/2-6);
		si.init();
		this.add(si);
		// lbl.setVisible(true);
		header = new XLabel();
	...
	public TransferPanel1() {
		// TODO Auto-generated constructor stub
	}

	public TransferPanel1(boolean arg0) {
		super(arg0);
		// TODO Auto-generated constructor stub
	}
