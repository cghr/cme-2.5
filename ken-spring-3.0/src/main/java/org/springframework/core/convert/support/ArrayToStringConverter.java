...
/* 11:   */ 
/* 12:   */ final class ArrayToStringConverter
/* 13:   */   implements ConditionalGenericConverter
/* 14:   */ {
/* 15:   */   private final CollectionToStringConverter helperConverter;
/* 16:   */   
/* 17:   */   public ArrayToStringConverter(ConversionService conversionService)
/* 18:   */   {
/* 19:40 */     this.helperConverter = new CollectionToStringConverter(conversionService);
/* 20:   */   }
/* 21:   */   
/* 22:   */   public Set<GenericConverter.ConvertiblePair> getConvertibleTypes()
/* 23:   */   {
/* 24:44 */     return Collections.singleton(new GenericConverter.ConvertiblePair([Ljava.lang.Object.class, String.class));
/* 25:   */   }
/* 26:   */   
 ...
 * Qualified Name:     org.springframework.core.convert.support.ArrayToStringConverter
