...
/*  8:   */ 
/*  9:   */ public class BeanFactoryAccessor
...
/* 14:   */   {
/* 15:36 */     return ((BeanFactory)target).containsBean(name);
/* 16:   */   }
/* 17:   */   
/* 18:   */   public TypedValue read(EvaluationContext context, Object target, String name)
/* 19:   */     throws AccessException
/* 20:   */   {
/* 21:40 */     return new TypedValue(((BeanFactory)target).getBean(name));
/* 22:   */   }
/* 23:   */   
...
/* 37:   */   {
/* 38:52 */     return new Class[] { BeanFactory.class };
/* 39:   */   }
/* 40:   */ }
