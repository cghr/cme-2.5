  ...
  implements AnnotationVisitor
{
  ...
  void a(ByteVector paramByteVector)
  {
    ...
    while (localObject1 != null)
    {
      ...
      ((AnnotationWriter)localObject1).h = localObject2;
  ...
  static void a(AnnotationWriter[] paramArrayOfAnnotationWriter, ByteVector paramByteVector)
  {
    int i = 1 + 2 * paramArrayOfAnnotationWriter.length;
    for (int j = 0; j < paramArrayOfAnnotationWriter.length; j++) {
      i += (paramArrayOfAnnotationWriter[j] == null ? 0 : paramArrayOfAnnotationWriter[j].a());
    }
    paramByteVector.putInt(i).putByte(paramArrayOfAnnotationWriter.length);
    for (j = 0; j < paramArrayOfAnnotationWriter.length; j++)
    {
 ...
 * Qualified Name:     org.springframework.asm.AnnotationWriter
