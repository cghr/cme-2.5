...
/*  5:   */ 
/*  6:   */ public class SybaseCallMetaDataProvider
...
/* 11:   */   
/* 12:   */   public SybaseCallMetaDataProvider(DatabaseMetaData databaseMetaData)
...
/* 30:   */   {
/* 31:58 */     return ("RETURN_VALUE".equals(parameterName)) || ("RETURN_VALUE".equals(parameterNameToUse(parameterName))) || (super.byPassReturnParameter(parameterName));
/* 32:   */   }
/* 33:   */ }
