  ...
  implements ClassVisitor
{
  ...
  public ClassWriter(ClassReader paramClassReader, boolean paramBoolean)
  {
    this(paramBoolean, false);
    paramClassReader.a(this);
    this.D = paramClassReader;
  }
  ...
  {
    return new MethodWriter(this, paramInt, paramString1, paramString2, paramString3, paramArrayOfString, this.C);
  }
  ...
  public byte[] toByteArray()
  {
    ...
    {
      if ((this.j & 0x2000) != 0) {
        localByteVector.putShort(newUTF8("Annotation")).putInt(0);
      }
      if ((this.j & 0x4000) != 0) {
        localByteVector.putShort(newUTF8("Enum")).putInt(0);
      }
    }
    if (this.x != null)
    {
  ...
  Item a(float paramFloat)
  {
    ...
    if (localItem == null)
    {
      this.d.putByte(4).putInt(Float.floatToIntBits(paramFloat));
      localItem = new Item(this.c++, this.g);
      b(localItem);
    }
    return localItem;
  ...
  Item a(double paramDouble)
  {
    ...
    if (localItem == null)
    {
      this.d.putByte(6).putLong(Double.doubleToLongBits(paramDouble));
      localItem = new Item(this.c, this.g);
      b(localItem);
      this.c += 2;
    }
